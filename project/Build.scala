  ...
  */
  ...
  lazy val commonDottyCompilerSettings = Seq(
      ...
      libraryDependencies ++= Seq(
        ...
        "ch.epfl.scala" %% "tasty-query" %"0.0.0+1226-275ea2d1+20250509-1526-SNAPSHOT",//"0.0.0+1226-275ea2d1+20250509-1516-SNAPSHOT",//"0.0.0+1226-275ea2d1+20250509-1457-SNAPSHOT", //"0.0.0+1226-275ea2d1+20250509-1450-SNAPSHOT",//"0.0.0+1226-275ea2d1+20241221-0226-SNAPSHOT",
      ),
